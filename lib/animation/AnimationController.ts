      ...
      frames: [
        {
          limbPositions: new Map([
            ...
            ['leftUpperLeg', { x: -5, y: 10, rotation: 0.3 }],
            ['rightUpperLeg', { x: 5, y: 10, rotation: -0.3 }],
          ]),
          duration: 150,
        },
        {
      ...
      frames: [
        ...
        },
        {
          limbPositions: new Map([
            ...
            ['rightLowerLeg', { x: 35, y: -5, rotation: -1.8 }],
            ['torso', { x: -5, y: 2, rotation: 0.2 }],
          ]),
          duration: 100,
          hitboxActive: true,
          damage: 10,
